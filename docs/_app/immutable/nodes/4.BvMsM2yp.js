import{A as e,B as t,D as n,I as r,M as i,N as a,T as o,U as s,W as c,_ as l,c as u,f as d,g as f,h as p,j as m,l as ee,o as h,s as te,x as g,y as _,z as ne}from"../chunks/D1pqj1Ks.js";import"../chunks/xihTtKlq.js";import{n as v}from"../chunks/DKAuReLO.js";import{t as y}from"../chunks/DRByVC-c.js";var b=c({entries:()=>re,load:()=>x}),re=()=>[`text`,`ping`,`role`,`translate`].flatMap(e=>[`docs`,`privacy`,`terms`].map(t=>({bot:e,section:t})));function x({params:e}){let t=v(e.bot);return(!t||![`docs`,`privacy`,`terms`].includes(e.section))&&y(404,`Page not found`),{bot:t,section:e.section}}var ie={text:{privacy:`# **Privacy Policy**
